...
int32_t upkg_ocount(void);	// returns the number of exports
const char *upkg_oname(int);		// returns the name of the export
const char *upkg_oclassname(int);	// returns the name of the export's class
const char *upkg_opackagename(int);	// returns the name of the export's package
const char *upkg_otype(int);		// returns the name of the type of object
